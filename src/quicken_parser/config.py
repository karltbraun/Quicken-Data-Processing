...
class OutputSettings:
    ...
    combined_tables: bool = True  # default now to single workbook when using xlsx
    ...
    def __post_init__(self):
        ...
        if not isinstance(self.combined_tables, bool):
            raise ValueError("combined_tables must be a boolean")
